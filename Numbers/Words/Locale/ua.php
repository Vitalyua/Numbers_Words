...
class Numbers_Words_Locale_ua extends Numbers_Words
{
    ...
    public $_currency_names = array(
        ...
        'IDR' => array(
            array(1, 'індонезійська   рупія', 'індонезійських  рупії', 'індонезійських  рупій'),
            array(1, '', '', ''),
        ),
        'CDF' => array(
            array(1, 'конголезький франк', 'конголезьких франка', 'конголезьких франків'),
            array(1, '', '', ''),
        ),
        'KES' => array(
            array(1, 'кенійський шилінг', 'кенійських шилінгів ', 'кенійських шилінгів'),
            array(1, 'цент', 'центи', 'центів'),
        ),
